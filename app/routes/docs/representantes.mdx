...
O meta caractere ponto `.` é utilizado para representar qualquer coisa, qualquer caractere, exceto quebra de linha (porém esse comportamento pode ser alterado com a <Link to="/docs/flags#s">flag <code>s</code></Link>).
